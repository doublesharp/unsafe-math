...
describe('UnsafeI256', () => {
  ...
  describe('Math', () => {
    it('Add', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.add(1, 2);
    ...
    it('Sub', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.sub(2, 1);
    ...
    it('Mul', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.mul(2, 2);
    ...
    it('Div', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.div(4, 2);
    ...
    it('Mod', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.mod(333, 2);
  ...
  describe('Bitwise', () => {
    it('And', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.and(0x0f, 0x03);
    ...
    it('Or', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.or(0x0f, 0x03);
    ...
    it('Xor', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.xor(0x0f, 0x03);
    ...
    it('Not', async () => {
      ...
      [unsafeGas, unsafeResult] = await testUnsafeI256.not(0x0f);
  ...
  describe('Comparison', () => {
    it('Eq', async () => {
      ...
      [unsafeGas, unsafeBoolResult] = await testUnsafeI256.eq(0x0f, 0x0f);
    ...
    it('Neq', async () => {
      ...
      [unsafeGas, unsafeBoolResult] = await testUnsafeI256.neq(0x0f, 0x0f);
    ...
    it('Lt', async () => {
      ...
      [unsafeGas, unsafeBoolResult] = await testUnsafeI256.lt(0x0f, 0x0f);
    ...
    it('Lte', async () => {
      ...
      [unsafeGas, unsafeBoolResult] = await testUnsafeI256.lte(0x0f, 0x0f);
    ...
    it('Gt', async () => {
      ...
      [unsafeGas, unsafeBoolResult] = await testUnsafeI256.gt(0x0f, 0x0f);
    ...
    it('Gte', async () => {
      ...
      [unsafeGas, unsafeBoolResult] = await testUnsafeI256.gte(0x0f, 0x0f);
  ...
  describe('Conversion', () => {
    it('asUints', async () => {
      ...
      const unsafeTypes = await testUnsafeI256.asUints(0x0f);
    ...
    it('asInts', async () => {
      ...
      const unsafeTypes = await testUnsafeI256.asInts(0x0f);
